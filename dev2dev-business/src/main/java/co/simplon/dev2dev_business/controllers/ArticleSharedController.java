...
import co.simplon.dev2dev_business.services.ArticleSharedService;
...
public class ArticleSharedController {
    private final ArticleSharedService articleSharedService;

    public ArticleSharedController(ArticleSharedService articleSharedService) {
    ...
    ResponseEntity<Void> createSharedArticle(@RequestBody @Valid ArticleShareDto inputs){
        articleSharedService.createSharedArticle(inputs);
