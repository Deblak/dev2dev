...
@Constraint(validatedBy = UniqueUrlValidator.class) // Indique que la règle de gestion de validation sera implémenter dans la class indiquée (ici UniqueTitleValidator.class)
